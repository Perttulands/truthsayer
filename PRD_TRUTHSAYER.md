...
- [x] **US-010**: As a developer, I want a human-readable terminal summary after each scan showing counts by severity and category.
...
- [x] **US-REVIEW-S4**: Review Sprint 4 — run tests, verify integration, fix issues.
